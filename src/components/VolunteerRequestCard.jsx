...
export default function VolunteerRequestCard(props) {
    ...
    return (
    <div
        className={"bg-teal-700 flex flex-row justify-around  shadow-sm px-2 py-2 w-2/3 rounded-md"}>
        <div className={"flex flex-row justify-between w-full text-slate-100"}>
            ...
            <div className="flex flex-col font-medium items-start text-1xl">
                <div> Volunteer Name: {individualUsers[userId].firstName + " " + individualUsers[userId].lastName}</div>
                ...
                {isExpanded&&<div className="flex flex-row justify-between gap-4">
                    ...
                    <div> Donor Location: {individualUsers[userId].address},{individualUsers[userId].area},{individualUsers[userId].governorate}</div>
                    {individualUsers[userId].type==="Doctor"&&<><div> Specialization: {individualUsers[userId].specialization}</div>
                    <div> Clinic Location: {individualUsers[userId].clinicAddress},{individualUsers[userId].clinicArea},{individualUsers[userId].clinicGovernorate}</div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div> Organization contact number:{organizations[organizationId].contactInfo.phone}</div>
